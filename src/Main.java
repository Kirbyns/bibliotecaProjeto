...
public class Main {
    ...
    public static void actionsAdmin(Scanner sc, Biblioteca biblioteca, Relatorio relatorio, Utilitarios utilitarios) {
        boolean run = true;
        while (run) {
            int response;
    ...
    public static void actionsFuncComAcesso(Funcionario funcionario, Scanner sc, Biblioteca biblioteca,
    ...
    public static void main(String[] args) {
        ...
        while (open) {
            ...
            if (open_response == 0) {
                ...
                switch (role) {
                    case 0:
                        actionsAdmin(sc, biblioteca, relatorio, utilitarios);
                        break;
                    case 1:

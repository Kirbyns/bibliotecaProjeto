    ...
    public static void main(String[] args) {
        ...
        while (open) {
            ...
            if (open_response == 0) {
                ...
                switch (role) {
                    case 0:
                        ActionsAdmin aa = new ActionsAdmin(sc, biblioteca, relatorio, utilitarios);
                        aa.menu();
                        break;
                    case 1:
                        Funcionario funcionario = utilitarios.findFuncionarioByLogin(email, senha,
                                biblioteca.getFuncionarios());
                        ActionsFuncComAcesso afca = new ActionsFuncComAcesso(funcionario, sc, biblioteca, relatorio,
                                utilitarios);
                        afca.menu();
                        break;
                    case 2:
                        Funcionario funcionarioSemAcesso = utilitarios.findFuncionarioByLogin(email, senha,
                                biblioteca.getFuncionarios());
                        ActionsFuncSemAcesso actionsFuncSemAcesso = new ActionsFuncSemAcesso(funcionarioSemAcesso, sc,
